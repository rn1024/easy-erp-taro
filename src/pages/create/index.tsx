...
const Create: React.FC = () => {
  ...
  return (
    <View className="create-page">
      <View className="create-page__content">
        {/* 分类选择 */}
        <View className="create-page__categories">
          <View className="create-page__category-tabs">
            {categories.map(category => (
              <View
                key={category}
                className={`create-page__category-tag ${
                  selectedCategory === category ? 'create-page__category-tag--active' : ''
                }`}
        ...
        {/* 模板列表 */}
        <View className="create-page__templates">
          <View className="create-page__templates-header">
            <Text className="create-page__templates-title">选择模板</Text>
          </View>
          
          <View className="create-page__templates-grid">
            {filteredTemplates.map(template => {
              return (
                <View 
                  key={template.id}
                  className={`create-page__template-card ${
                    selectedTemplate?.id === template.id ? 'create-page__template-card--selected' : ''
                  }`}
        ...
        {selectedTemplate && selectedTemplate.id !== 'custom' && (
          <View className="create-page__quick-start">
            <View className="create-page__quick-start-card">
              <View className="create-page__quick-start-content">
                <Text className="create-page__quick-start-title">快速开始</Text>
                <Text className="create-page__quick-start-desc">
                  使用"{selectedTemplate.name}"模板快速创建工作流程
                </Text>
                <Button
                  className="create-page__quick-start-btn"
                  type="primary"
